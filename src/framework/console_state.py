...
class ConsoleState:
    """
    Params
        :display_text: the text to display on the display part of the Console cycle
        :prompt_text: the text to prompt user input on the input part of the Console cycle
    """
